...
public class Client  {
    ...
    public int poolLimit = 60, app = 0;
    public List<string> last, last2, GroupPools, GroupPowers = new List<string>();
    public bool hidden = false, botOnline = false, gotTickled = false, _null = false, switchingPools = false, joined = false, away = false, authenticated = false, online = false, disconnect = false, mobready = false, chatPass = false;
